...
function startChat() {
    ...
    $(document).ready(function () {
        ...
        setTimeout(function () {
            messenger.recieve('Hola!!!');
        }, 1500);

        setTimeout(function () {
            messenger.recieve('Esta pagina del ayuntamiento esta genial, ¿no creeis?');
        }, 5000);

        setTimeout(function () {
            messenger.recieve('Yo opino igual que tu esta genial!!!!!');
        }, 7500);

        setTimeout(function () {
            messenger.recieve('Esta vez se han lucido la verdad, se merecen un 10 los desarroladores! +1 si me pensais igual');
        }, 10000);
